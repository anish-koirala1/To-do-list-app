...
<head>
    ...
    <title><?= htmlspecialchars($pageTitle) ?> &mdash; Todo App</title>
...
<header class="site-header">
    <div class="header-inner">
        ...
        <nav class="site-nav">
            <a href="<?= $baseUrl ?? '../' ?>tasks/index.php" class="nav-link <?= (strpos($_SERVER['PHP_SELF'], '/tasks/') !== false) ? 'active' : '' ?>">
            ...
            <a href="<?= $baseUrl ?? '../' ?>assignments/index.php" class="nav-link <?= (strpos($_SERVER['PHP_SELF'], '/assignments/') !== false) ? 'active' : '' ?>">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
